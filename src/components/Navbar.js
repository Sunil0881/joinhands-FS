        ...
        <header className='bg-black px-8 h-12 pt-2 text-white'>
            <nav className="flex justify-between items-center w-full mx-auto">
                ...
                <div className="flex items-center gap-6">
                    <button className="flex bg-red-600 px-2 py-1 justify-center rounded-full text-white hover:bg-white hover:text-red-600"><Link to={'/signin'}>Signin/up</Link></button>
                    {menuOpen ? (
